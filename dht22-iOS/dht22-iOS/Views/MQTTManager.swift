...
//        if (message.topic == "lidar/process") {
//            currentAppState.setProcess(text: message.string!.description)
//        }
//        
//        if (message.topic == "lidar/positions") {
//            currentAppState.setPositions(text: message.string!.description)
//        }
        if (message.topic == "dht/temp") {
            currentAppState.setTemps(text: message.string!.description)
        }
        
        if (message.topic == "dht/humidity") {
            currentAppState.setHumidity(text: message.string!.description)
        }
